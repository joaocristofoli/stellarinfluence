...
import { ListTodo, Link2, Calendar, Target, User, Users } from "lucide-react";
...
export function StrategyDetailsModal({ strategy, open, onClose, allStrategies }: StrategyDetailsModalProps) {
